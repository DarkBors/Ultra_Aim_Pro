...
"color: rgb(155, 155, 255);")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.labelTitle.setText(QCoreApplication.translate("SplashScreen", u"<html><head/><body><p><span style=\" font-weight:600; color:#9b9bff;\">ULTRA-AIM</span>  PRO</p></body></html>", None))
