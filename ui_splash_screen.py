...
class Ui_SplashScreen(object):
    def setupUi(self, SplashScreen):
        ...
        self.circularProgressBarBase.setGeometry(10, 10, 320, 320)
        ...
        self.circularProgress.setGeometry(10, 10, 300, 300)
        ...
        self.circularBg.setGeometry(10, 10, 300, 300)
        ...
        self.container.setGeometry(25, 25, 270, 270)
        ...
        self.widget.setGeometry(40, 50, 193, 191)
        ...
        self.labelPercentage.setStyleSheet(
            u"background-color: none;\n"
            "color: #FFFFFF"
        )
        ...
        self.labelLoadingInfo.setMinimumSize(0, 20)
        self.labelLoadingInfo.setMaximumSize(16777215, 20)
        font2 = QFont()
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.labelTitle.setText(
            QCoreApplication.translate(
                "SplashScreen",
                u"<html><head/><body><p><span style=\" font-weight:600; color:#9b9bff;\">ULTRA-AIM</span> PRO</p></body></html>",
                None,
            )
        )
        ...
        self.labelCredits.setText(QCoreApplication.translate("SplashScreen", u"by: Eldarov Boris", None))
